...
namespace MushROMs.LunarCompress
{
    partial class LC
    {
        ...
        {
            get { return UnsafeNativeMethods.LunarGetFileSize(); }
        }
        #endregion
        ...
        {
            return OpenFile(path, FileMode.ReadOnly);
        }
        ...
        /// file at the same time, though of course that isn't recommended.
        /// </remarks>
        public static bool OpenFile(string path, FileMode fileMode)
        {
            CloseFile();
            LC.open = UnsafeNativeMethods.LunarOpenFile(path, fileMode);
        ...
        {
            return OpenRAMFile(path, FileMode.ReadOnly, LockArraySizeOptions.None, false, 0);
        }
        ...
        /// there's still the overhead of loading/saving the entire file.
        /// </remarks>
        public static IntPtr OpenRAMFile(string path, FileMode fileMode)
        {
        ...
        /// there's still the overhead of loading/saving the entire file.
        /// </remarks>
        public static IntPtr OpenRAMFile(string path, FileMode fileMode, LockArraySizeOptions flags)
        {
        ...
        /// there's still the overhead of loading/saving the entire file.
        /// </remarks>
        public static IntPtr OpenRAMFile(string path, FileMode fileMode, LockArraySizeOptions flags, bool saveOnClose)
        {
        ...
        /// there's still the overhead of loading/saving the entire file.
        /// </remarks>
        public static IntPtr OpenRAMFile(string path, FileMode fileMode, LockArraySizeOptions flags, bool saveOnClose, int minSize)
        {
            CloseFile();
            LC.data = UnsafeNativeMethods.LunarOpenRAMFile(path, (int)fileMode | (int)flags | CREATEARRAY | (saveOnClose ? SAVEONCLOSE : 0), minSize);
        ...
        {
            return OpenRAMFile(data, size, FileMode.ReadOnly, LockArraySizeOptions.None);
        }
        ...
        /// there's still the overhead of loading/saving the entire file.
        /// </remarks>
        public static IntPtr OpenRAMFile(IntPtr data, int size, FileMode fileMode)
        {
        ...
        /// there's still the overhead of loading/saving the entire file.
        /// </remarks>
        public static IntPtr OpenRAMFile(IntPtr data, int size, FileMode fileMode, LockArraySizeOptions flags)
        {
            CloseFile();
            return LC.data = UnsafeNativeMethods.LunarOpenRAMFile(data, (int)fileMode | (int)flags, size);
        }
        ...
        {
            return UnsafeNativeMethods.LunarSaveRAMFile(null);
        }
        ...
        {
            if (UnsafeNativeMethods.LunarSaveRAMFile(path))
            {
                if (path != null)
                    LC.path = path;
                return true;
        ...
        {
            bool closed = UnsafeNativeMethods.LunarCloseFile();
            if (closed)
            {
                LC.open = false;
        ...
        {
            return UnsafeNativeMethods.LunarReadFile(dest, size, address, (seek ? SEEK : NOSEEK));
        }
        ...
        {
            return UnsafeNativeMethods.LunarWriteFile(data, size, address, (seek ? SEEK : NOSEEK));
        }
        ...
        /// </param>
        /// <param name="erase">
        /// Byte for erasing (good idea to make same as <paramref name="value1"/> or <paramref name="value2"/>).
        /// </param>
        /// <returns>
        /// True on success, false on fail.
        /// </returns>
        public static bool SetFreeBytes(byte value1, byte value2, byte erase)
        {
            return SafeNativeMethods.LunarSetFreeBytes((value1 | (value2 << 8) | (erase << 0x10)));
        }
        ...
        /// are not accessible.
        /// </remarks>
        public static int SNEStoPC(int pointer, ROMType romType, bool header)
        {
            return SafeNativeMethods.LunarSNEStoPC(pointer, romType, (header ? HEADER : NOHEADER));
        }
        ...
        /// are not accessible.
        /// </remarks>
        public static int PCtoSNES(int pointer, ROMType romType, bool header)
        {
            return SafeNativeMethods.LunarPCtoSNES(pointer, romType, (header ? HEADER : NOHEADER));
        }
        ...
        {
            return UnsafeNativeMethods.LunarEraseArea(offset, size);
        }
        ...
        /// For sizes greater than 32Mbit, use <see cref="ExpandROM(ExROMExpansionMode)"/>
        /// </param>
        /// <returns>
        ...
        {
            return UnsafeNativeMethods.LunarExpandROM(mBits);
        }
        ...
        /// For sizes less than 32Mbit, use <see cref="ExpandROM(ExROMExpansionMode)"/>
        /// </param>
        /// <returns>
        /// The expanded size of the ROM. If the ROM is bigger than the size passed, returns the ROMs original size.
        /// Returns 0 on fail.
        ...
        /// (or 1.39mk3) or higher (zsnes does not yet support these).
        /// </remarks>
        public static int ExpandROM(ExROMExpansionMode mBits)
        {
            return UnsafeNativeMethods.LunarExpandROM((int)mBits);
        }
        #endregion
    }
}
