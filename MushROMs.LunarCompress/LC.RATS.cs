...
namespace MushROMs.LunarCompress
{
    partial class LC
    {
        ...
        #region Methods
        /// <summary>
        /// Verifies free space in the 
        /// available for inserting data (free space is
        ...
        /// failure.
        /// </returns>
        public static int VerifyFreeSpace(int addressStart, int addressEnd, int size, BankType bankType)
        {
            return UnsafeNativeMethods.LunarVerifyFreeSpace(addressStart, addressEnd, size, bankType);
        }
        ...
        {
            return WriteRATArea(data, 0, LC.FileSize, 0, 0, data.Length, RATFunctionFlags.None);
        }
        ...
        {
            return WriteRATArea(data, minRange, maxRange, 0, 0, data.Length, RATFunctionFlags.None);
        }
        ...
        public static int WriteRATArea(byte[] data, int minRange, int maxRange, int preferredAddress)
        {
            ...
            return WriteRATArea(data, minRange, maxRange, preferredAddress, 0, data.Length, RATFunctionFlags.None);
        }
        ...
        {
            return WriteRATArea(data, minRange, maxRange, preferredAddress, offset, size, RATFunctionFlags.None);
        }
        ...
        {
            return UnsafeNativeMethods.LunarWriteRatArea(data, size, preferredAddress, minRange, maxRange, flags);
        }
        ...
        {
            return EraseRATArea(address, RATEraseFlags.None, CompressionFormat.None, 0);
        }
        ...
        {
            return EraseRATArea(address, flags, CompressionFormat.None, 0);
        }
        ...
        /// If the data has no RAT, the function can attempt to get the size by using <see cref="Decompress(CompressionFormat)"/>.
        /// Do not attempt to use a format that requires knowing the size of the decompressed data in advance, such as <see cref="CompressionFormat.RLE3"/>.
        /// </param>
        /// <returns>
        /// The size of the data erased, not including the RAT (if it exists). It returns 0 on failure.
        /// </returns>
        public static int EraseRATArea(int address, RATEraseFlags flags, CompressionFormat compressionFormat)
        {
        ...
        /// The size of the data erased, not including the RAT (if it exists). It returns 0 on failure.
        /// </returns>
        public static int EraseRATArea(int address, RATEraseFlags flags, CompressionFormat compressionFormat, int size)
        {
            return UnsafeNativeMethods.LunarEraseRatArea(address, size, (int)flags | (compressionFormat != CompressionFormat.None ? ((int)compressionFormat | COMPRESSED) : 0));
        }
        ...
        {
            return GetRATAreaSize(address, CompressionFormat.None);
        }
        ...
        /// The size of the data, not including the RAT (if it exists). It returns 0 on failure.
        /// </returns>
        public static int GetRATAreaSize(int address, CompressionFormat compressionFormat)
        {
            return UnsafeNativeMethods.LunarGetRatAreaSize(address, (compressionFormat != CompressionFormat.None ? ((int)compressionFormat | COMPRESSED) : 0));
        }
        #endregion
    }
}
