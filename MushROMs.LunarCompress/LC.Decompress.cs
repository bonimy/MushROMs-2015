...
namespace MushROMs.LunarCompress
{
    partial class LC
    {
        ...
        /// </returns>
        public static int GetDecompressSize(CompressionFormat compressionFormat)
        {
        ...
        /// failure or a decompressed structure of size 0.
        /// </returns>
        public static int GetDecompressSize(CompressionFormat compressionFormat, int offset)
        {
        ...
        /// failure or a decompressed structure of size 0.
        /// </returns>
        public static int GetDecompressSize(CompressionFormat compressionFormat, int offset, int otherOptions)
        {
            return UnsafeNativeMethods.LunarDecompress(IntPtr.Zero, offset, 0, compressionFormat, otherOptions, IntPtr.Zero);
        }
        ...
        /// failure or a decompressed structure of size 0.
        /// </returns>
        public static int GetDecompressSize(CompressionFormat compressionFormat, int offset, int otherOptions, out int lastROMPosition)
        {
            return UnsafeNativeMethods.LunarDecompress(IntPtr.Zero, offset, 0, compressionFormat, otherOptions, out lastROMPosition);
        }
        ...
        /// </returns>
        public static byte[] Decompress(CompressionFormat compressionFormat)
        {
        ...
        /// </remarks>
        public static byte[] Decompress(CompressionFormat compressionFormat, int maxSize)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static byte[] Decompress(CompressionFormat compressionFormat, int maxSize, int offset)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static byte[] Decompress(CompressionFormat compressionFormat, int maxSize, int offset, int otherOptions)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static byte[] Decompress(CompressionFormat compressionFormat, int maxSize, int offset, int otherOptions, out int lastROMPosition)
        {
            byte[] data = new byte[maxSize];
            unsafe
            {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Decompress(IntPtr destination, CompressionFormat compressionFormat)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Decompress(IntPtr destination, CompressionFormat compressionFormat, int maxSize)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Decompress(IntPtr destination, CompressionFormat compressionFormat, int maxSize, int offset)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Decompress(IntPtr destination, CompressionFormat compressionFormat, int maxSize, int offset, int otherOptions)
        {
            return UnsafeNativeMethods.LunarDecompress(destination, offset, maxSize, compressionFormat, otherOptions, IntPtr.Zero);
        }
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Decompress(IntPtr destination, CompressionFormat compressionFormat, int maxSize, int offset, int otherOptions, out int lastROMPosition)
        {
            return UnsafeNativeMethods.LunarDecompress(destination, offset, maxSize, compressionFormat, otherOptions, out lastROMPosition);
        }
        #endregion
    }
}
