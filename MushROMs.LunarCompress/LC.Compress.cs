...
namespace MushROMs.LunarCompress
{
    partial class LC
    {
        ...
        /// </returns>
        public static int GetCompressSize(byte[] data, CompressionFormat compressionFormat)
        {
            if (data == null)
                return 0;
        ...
        /// The size of the compressed data. A value of zero indicates failure.
        /// </returns>
        public static int GetCompressSize(byte[] data, CompressionFormat compressionFormat, int address, int dataSize)
        {
        ...
        /// The size of the compressed data. A value of zero indicates failure.
        /// </returns>
        public static int GetCompressSize(byte[] data, CompressionFormat compressionFormat, int address, int dataSize, int otherOptions)
        {
            if (data == null)
                return 0;
        ...
        /// The size of the compressed data. A value of zero indicates failure.
        /// </returns>
        public static int GetCompressSize(IntPtr data, CompressionFormat compressionFormat, int dataSize)
        {
        ...
        /// The size of the compressed data. A value of zero indicates failure.
        /// </returns>
        public static int GetCompressSize(IntPtr data, CompressionFormat compressionFormat, int dataSize, int otherOptions)
        {
            return UnsafeNativeMethods.LunarRecompress(data, IntPtr.Zero, dataSize, 0, compressionFormat, otherOptions);
        }
        ...
        /// </returns>
        public static byte[] Recompress(byte[] data, CompressionFormat compressionFormat)
        {
            if (data == null)
                return null;
        ...
        /// A byte array of the compressed data. Returns null on failure.
        /// </returns>
        public static byte[] Recompress(byte[] data, CompressionFormat compressionFormat, int address, int dataSize)
        {
            if (data == null)
                return null;
        ...
        /// </remarks>
        public static byte[] Recompress(byte[] data, CompressionFormat compressionFormat, int maxSize)
        {
            if (data == null)
                return null;
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static byte[] Recompress(byte[] data, CompressionFormat compressionFormat, int maxSize, int address, int dataSize)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static byte[] Recompress(byte[] data, CompressionFormat compressionFormat, int maxSize, int address, int dataSize, int otherOptions)
        {
            ...
            unsafe
            {
                ...
                fixed (byte* dest = compressed)
                    return UnsafeNativeMethods.LunarRecompress((IntPtr)src, (IntPtr)dest, dataSize, maxSize, compressionFormat, otherOptions) != 0 ? compressed : null;
            }
        }
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Recompress(IntPtr source, IntPtr destination, int dataSize, int maxSize, CompressionFormat compressionFormat)
        {
        ...
        /// array but the function will still compress the data so it can return the size of it.
        /// </remarks>
        public static int Recompress(IntPtr source, IntPtr destination, int dataSize, int maxSize, CompressionFormat compressionFormat, int otherOptions)
        {
            return UnsafeNativeMethods.LunarRecompress(source, destination, dataSize, maxSize, compressionFormat, otherOptions);
        }
        #endregion
    }
}